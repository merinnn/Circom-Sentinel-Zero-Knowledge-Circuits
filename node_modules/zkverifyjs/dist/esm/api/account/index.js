 ...
 */
export const setupAccount = (secretSeedPhrase, isMainnetNetwork) => {
  try {
    const ss58Prefix = isMainnetNetwork ? ZKVERIFY_CHAIN_SS58_PREFIX : VOLTA_CHAIN_SS58_PREFIX;
...
export const canonicalAddress = (pairOrPublicKey, isMainnetNetwork) => {
  const pk = pairOrPublicKey instanceof Uint8Array ? pairOrPublicKey : pairOrPublicKey.publicKey;
  const ss58Prefix = isMainnetNetwork ? ZKVERIFY_CHAIN_SS58_PREFIX : VOLTA_CHAIN_SS58_PREFIX;
