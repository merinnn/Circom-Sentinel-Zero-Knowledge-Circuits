  ...
  try {
    ...
    return {
      ...
      proof: {
        ...
        b: formatG2Point([[proofData.Bs.X.A0, proofData.Bs.X.A1], [proofData.Bs.Y.A0, proofData.Bs.Y.A1]], endianess, curve),
...
export const formatVk = (vk, options) => {
  try {
    ...
    return {
      ...
      beta_g2: formatG2Point([[vkData.G2.Beta.X.A0, vkData.G2.Beta.X.A1], [vkData.G2.Beta.Y.A0, vkData.G2.Beta.Y.A1]], endianess, curve),
      gamma_g2: formatG2Point([[vkData.G2.Gamma.X.A0, vkData.G2.Gamma.X.A1], [vkData.G2.Gamma.Y.A0, vkData.G2.Gamma.Y.A1]], endianess, curve),
      delta_g2: formatG2Point([[vkData.G2.Delta.X.A0, vkData.G2.Delta.X.A1], [vkData.G2.Delta.Y.A0, vkData.G2.Delta.Y.A1]], endianess, curve),
